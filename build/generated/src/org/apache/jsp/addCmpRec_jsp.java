...
public final class addCmpRec_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            \r\n");
      out.write("        <table>\r\n");
      out.write("            <tr  colspan=\"2\"><td>Basic Details</td></tr>\r\n");
      out.write("            <tr><td>Component Name</td><td><input name=\"cmpName\" type=\"text\"/></td></tr>\r\n");
      out.write("            <tr><td>Part Number</td><td><input name=\"partNum\" type=\"text\"/></td></tr>\r\n");
      out.write("            <tr><td>Serial Number</td><td><input name=\"srNum\" type=\"text\"/></td></tr>\r\n");
      out.write("            <tr><td>Finite Life Hrs</td><td><input name=\"flHrs\" type=\"text\"/>&nbsp;&nbsp;<select name=\"flHrsType\"><option value=\"H\">Hours</option><option value=\"Y\">Years</option><option value=\"L\">Landing Count</option></select></td></tr>\r\n");
      out.write("            <tr colspan=\"2\"><td >Installation Details</td></tr>\r\n");
      out.write("            <tr><td>Life Remaining Hrs</td><td><input name=\"lrInstHrs\" type=\"text\"/>&nbsp;&nbsp;<select name=\"lrInstHrsType\"><option value=\"H\">Hours</option><option value=\"Y\" >Years</option><option value=\"L\">Landing Count</option></select></td></tr>\r\n");
      out.write("            <tr><td>Installation A/F Hrs</td><td><input name=\"afInstHrs\" type=\"text\"/>&nbsp;&nbsp;<select name=\"afInstHrsType\"><option value=\"H\">Hours</option><option value=\"D\" >Date</option><option value=\"L\">Landing Count</option></select></td></tr>\r\n");
      out.write("            <tr><td>Installation Date</td><td><input name=\"InstDate\" type=\"text\"/>&nbsp;&nbsp;(DD-MM-YYYY)</td></tr>\r\n");
      out.write("            <tr><td>Installation Due Hrs</td><td><input name=\"InstDueHrs\" type=\"text\"/>&nbsp;&nbsp;<select name=\"InstDueHrsType\"><option value=\"H\">Hours</option><option value=\"D\" >Date</option><option value=\"L\">Landing Count</option></select></td></tr>\r\n");
      out.write("            <tr colspan=\"2\"><td>Current Component Details</td></tr>\r\n");
      out.write("            <tr><td>Current A/F Hrs</td><td><input name=\"crAFHrs\" type=\"text\"/>&nbsp;&nbsp;<select name=\"crAFHrsType\"><option value=\"H\">Hours</option><option value=\"D\" >Date</option><option value=\"L\" >Landings</option></select></td></tr>\r\n");
      out.write("            <tr><td>Remaining Life Hrs</td><td><input name=\"rLifeHrs\" type=\"text\"/>&nbsp;&nbsp;<select name=\"rLifeHrsType\"><option value=\"H\">Hours</option><option value=\"D\" >Date</option><option value=\"L\" >Landings</option></select></td></tr>\r\n");
      out.write("            <tr><td>Remarks</td><td><input name=\"remText\" type=\"text\"/></td></tr>\r\n");
      out.write("        </table>\r\n");
      out.write("            <br/>\r\n");
      out.write("            <br/>\r\n");
